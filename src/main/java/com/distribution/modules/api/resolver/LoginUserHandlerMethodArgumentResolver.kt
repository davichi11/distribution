package com.distribution.modules.api.resolver
...
class LoginUserHandlerMethodArgumentResolver : HandlerMethodArgumentResolver {
    ...
    override fun supportsParameter(parameter: MethodParameter): Boolean {
        return parameter.parameterType.isAssignableFrom(UserEntity::class.java) &&
    ...
    override fun resolveArgument(parameter: MethodParameter, container: ModelAndViewContainer?,
        ...
        //获取用户ID
        val any = request.getAttribute(AuthorizationInterceptor.LOGIN_USER_KEY, RequestAttributes.SCOPE_REQUEST)
                ?: return null
        //获取用户信息
        return userService!!.queryObject(any.toString())
    }
}
