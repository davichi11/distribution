package com.distribution.weixin.wxpay.demo;

import com.alibaba.fastjson.JSON;
import com.distribution.common.utils.DateUtils;
import com.distribution.common.utils.MoneyUtil;
import com.distribution.weixin.wxpay.utils.GetWxOrderno;
import com.distribution.weixin.wxpay.utils.RequestHandler;
import com.distribution.weixin.wxpay.utils.Sha1Util;
import com.distribution.weixin.wxpay.utils.TenpayUtil;
...
//		packageParams.put("product_id", "123123");
        ...
        String xml = "<xml>" + "<appid>" + appid + "</appid>" + "<mch_id>"
                ...
                + "</notify_url>" + "<trade_type>" + tradeType
                + "</trade_type>" + "</xml>";
        String codeUrl = "";
        String createOrderURL = "https://api.mch.weixin.qq.com/pay/unifiedorder";

        System.out.println("xml:" + xml);
        codeUrl = GetWxOrderno.getCodeUrl(createOrderURL, xml);
    ...
    public static String getPackage(WxPayDto tpWxPayDto) {
        ...
        System.out.println("V3 jsApi package:" + JSON.toJSONString(finalpackage));
