...
public class SysUserTokenRecord extends UpdatableRecordImpl<SysUserTokenRecord> implements Record4<Long, String, Timestamp, Timestamp> {
     ...
     */
    @Override
    public SysUserTokenRecord value3(Timestamp value) {
        setExpireTime(value);
        return this;
    }
     ...
     */
    @Override
    public SysUserTokenRecord value4(Timestamp value) {
        setUpdateTime(value);
        return this;
    }
     ...
     */
    @Override
    public SysUserTokenRecord values(Long value1, String value2, Timestamp value3, Timestamp value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SysUserTokenRecord(Long userId, String token, Timestamp expireTime, Timestamp updateTime) {
        super(SysUserToken.SYS_USER_TOKEN);
