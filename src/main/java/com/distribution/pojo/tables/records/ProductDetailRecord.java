...
public class ProductDetailRecord extends UpdatableRecordImpl<ProductDetailRecord> implements Record7<String, String, Integer, String, Long, String, String> {

    private static final long serialVersionUID = -1101338170;
     ...
     */
    @Override
    public Row7<String, String, Integer, String, Long, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row7<String, String, Integer, String, Long, String, String> valuesRow() {
     ...
     */
    @Override
    public ProductDetailRecord values(String value1, String value2, Integer value3, String value4, Long value5, String value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProductDetailRecord(String id, String prodDetailName, Integer prodDetailBuyBack, String prodTypeId, Long prodDetailValue, String prodDetailCount, String prodDetailUrl) {
        super(ProductDetail.PRODUCT_DETAIL);
