...
public class PosApplyRecord extends UpdatableRecordImpl<PosApplyRecord> implements Record8<String, String, Long, String, String, Boolean, String, String> {

    private static final long serialVersionUID = 565807743;
     ...
     */
    @Override
    public Row8<String, String, Long, String, String, Boolean, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row8<String, String, Long, String, String, Boolean, String, String> valuesRow() {
     ...
     */
    @Override
    public PosApplyRecord values(String value1, String value2, Long value3, String value4, String value5, Boolean value6, String value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PosApplyRecord(String id, String name, Long mobile, String merchants, String areaCode, Boolean attribute, String addTime, String isDelete) {
        super(PosApply.POS_APPLY);
