...
public class ProductTypeRecord extends UpdatableRecordImpl<ProductTypeRecord> implements Record5<String, String, String, String, String> {

    private static final long serialVersionUID = -1784784025;
     ...
     */
    @Override
    public ProductTypeRecord values(String value1, String value2, String value3, String value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProductTypeRecord(String id, String prodName, String prodRate, String prodRemark, String prodImg) {
        super(ProductType.PRODUCT_TYPE);
