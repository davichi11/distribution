...
public class DistrictRecord extends TableRecordImpl<DistrictRecord> implements Record5<Short, String, Short, String, Boolean> {

    private static final long serialVersionUID = -330710649;
     ...
     */
    @Override
    public Row5<Short, String, Short, String, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row5<Short, String, Short, String, Boolean> valuesRow() {
     ...
     */
    @Override
    public DistrictRecord value5(Boolean value) {
        setOrder(value);
        return this;
    }
     ...
     */
    @Override
    public DistrictRecord values(Short value1, String value2, Short value3, String value4, Boolean value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DistrictRecord(Short id, String name, Short parentId, String code, Boolean order) {
        super(District.DISTRICT);
