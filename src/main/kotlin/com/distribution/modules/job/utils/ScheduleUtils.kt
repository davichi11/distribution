...
object ScheduleUtils {
    ...
    fun createScheduleJob(scheduler: Scheduler, scheduleJob: ScheduleJobEntity) {
        try {
            ...
            //放入参数，运行时的方法可以获取
            jobDetail.jobDataMap[ScheduleJobEntity().JOB_PARAM_KEY] = Gson().toJson(scheduleJob)
    ...
    fun updateScheduleJob(scheduler: Scheduler, scheduleJob: ScheduleJobEntity) {
        try {
            ...
            //参数
            trigger.jobDataMap[ScheduleJobEntity().JOB_PARAM_KEY] = Gson().toJson(scheduleJob)
    ...
    fun run(scheduler: Scheduler, scheduleJob: ScheduleJobEntity) {
        ...
        dataMap[ScheduleJobEntity().JOB_PARAM_KEY] = Gson().toJson(scheduleJob)
