...
public class Indexes {
    ...
    public static final Index PRODUCT_DETAIL_PRODUCT_DETAIL_PROD_TYPE_ID_INDEX = Indexes0.PRODUCT_DETAIL_PRODUCT_DETAIL_PROD_TYPE_ID_INDEX;
    public static final Index PRODUCT_DETAIL_PARAMS_PRIMARY = Indexes0.PRODUCT_DETAIL_PARAMS_PRIMARY;
    public static final Index PRODUCT_DETAIL_PARAMS_PRODUCT_DETAIL_PARAMS_DETAIL_ID_INDEX = Indexes0.PRODUCT_DETAIL_PARAMS_PRODUCT_DETAIL_PARAMS_DETAIL_ID_INDEX;
    public static final Index PRODUCT_DETAIL_PARAMS_PRODUCT_DETAIL_PARAMS_ID_INDEX = Indexes0.PRODUCT_DETAIL_PARAMS_PRODUCT_DETAIL_PARAMS_ID_INDEX;
    ...
    public static final Index PRODUCT_TYPE_PARAMS_PRODUCT_TYPE_PARAMS_ID_INDEX = Indexes0.PRODUCT_TYPE_PARAMS_PRODUCT_TYPE_PARAMS_ID_INDEX;
    public static final Index PRODUCT_TYPE_PARAMS_PRODUCT_TYPE_PARAMS_TYPE_ID_INDEX = Indexes0.PRODUCT_TYPE_PARAMS_PRODUCT_TYPE_PARAMS_TYPE_ID_INDEX;
    ...
    private static class Indexes0 {
        ...
        public static Index PRODUCT_DETAIL_PRODUCT_DETAIL_PROD_TYPE_ID_INDEX = Internal.createIndex("product_detail_prod_type_id_index", ProductDetail.PRODUCT_DETAIL, new OrderField[] { ProductDetail.PRODUCT_DETAIL.PROD_TYPE_ID }, false);
        ...
        public static Index PRODUCT_DETAIL_PARAMS_PRODUCT_DETAIL_PARAMS_DETAIL_ID_INDEX = Internal.createIndex("product_detail_params_detail_id_index", ProductDetailParams.PRODUCT_DETAIL_PARAMS, new OrderField[] { ProductDetailParams.PRODUCT_DETAIL_PARAMS.DETAIL_ID }, false);
        public static Index PRODUCT_DETAIL_PARAMS_PRODUCT_DETAIL_PARAMS_ID_INDEX = Internal.createIndex("product_detail_params_id_index", ProductDetailParams.PRODUCT_DETAIL_PARAMS, new OrderField[] { ProductDetailParams.PRODUCT_DETAIL_PARAMS.ID }, false);
        ...
        public static Index PRODUCT_TYPE_PARAMS_PRODUCT_TYPE_PARAMS_ID_INDEX = Internal.createIndex("product_type_params_id_index", ProductTypeParams.PRODUCT_TYPE_PARAMS, new OrderField[] { ProductTypeParams.PRODUCT_TYPE_PARAMS.ID }, false);
        public static Index PRODUCT_TYPE_PARAMS_PRODUCT_TYPE_PARAMS_TYPE_ID_INDEX = Internal.createIndex("product_type_params_type_id_index", ProductTypeParams.PRODUCT_TYPE_PARAMS, new OrderField[] { ProductTypeParams.PRODUCT_TYPE_PARAMS.TYPE_ID }, false);
