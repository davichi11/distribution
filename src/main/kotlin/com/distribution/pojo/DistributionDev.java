...
public class DistributionDev extends SchemaImpl {

    private static final long serialVersionUID = -1219270631;

    /**
     * The reference instance of <code>distribution_dev</code>
     */
    public static final DistributionDev DISTRIBUTION_DEV = new DistributionDev();
     ...
     * 意见反馈表
     */
    public final Feedback FEEDBACK = com.distribution.pojo.tables.Feedback.FEEDBACK;
     ...
     */
    private DistributionDev() {
        super("distribution_dev", null);
    }
