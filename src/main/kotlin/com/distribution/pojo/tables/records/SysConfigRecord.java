...
public class SysConfigRecord extends UpdatableRecordImpl<SysConfigRecord> implements Record5<Long, String, String, Integer, String> {
     ...
     */
    @Override
    public SysConfigRecord values(Long value1, String value2, String value3, Integer value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SysConfigRecord(Long id, String key, String value, Integer status, String remark) {
        super(SysConfig.SYS_CONFIG);
